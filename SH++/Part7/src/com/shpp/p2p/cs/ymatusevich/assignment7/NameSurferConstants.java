...
public interface NameSurferConstants {
    ...
    /**
     * The font for labels on the graph
     */
    public static final Font LABEL_FONT = new Font("TimesRoman", Font.BOLD, 20);

    /**
     * The array of colors for graph lines
     */
    public static final Color[] LINE_COLORS = new Color[]{Color.blue, Color.red, Color.magenta, Color.black};
