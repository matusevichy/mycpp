...
public class Steganography extends SimpleProgram implements com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyConstants {
    ...
    private com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyDrawingCanvas drawing = new com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyDrawingCanvas();
    private com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyPictureCanvas picture = new com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyPictureCanvas();
    ...
    private void hideMessage() {
        try {
            GImage e = com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyLogic.hideMessage(this.toBooleanArray(this.getImage(this.drawing)), this.getImage(this.picture));
            if (e == null) {
    ...
    private void recoverMessage() {
        try {
            this.drawing.setImage(this.toGImage(com.shpp.p2p.cs.vlisyuk.assignment6.sg.SteganographyLogic.findMessage(this.getImage(this.picture))));
