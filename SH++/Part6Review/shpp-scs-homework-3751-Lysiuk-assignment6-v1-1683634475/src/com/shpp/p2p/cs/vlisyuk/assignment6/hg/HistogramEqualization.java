...
public class HistogramEqualization extends WindowProgram implements ComponentListener {
    ...
    private void computeEqualizedImage() {
        ...
        int[][] pixels = com.shpp.p2p.cs.vlisyuk.assignment6.hg.HistogramEqualizationImageTransforms.toGrayscale(this.displayImage).getPixelArray();
        int[][] intensities = com.shpp.p2p.cs.vlisyuk.assignment6.hg.HistogramEqualizationImageTransforms.imageToLuminances(pixels);
        int[][] result = com.shpp.p2p.cs.vlisyuk.assignment6.hg.HistogramEqualizationLogic.equalize(intensities);
