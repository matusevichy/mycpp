...
public interface NameSurferConstants {
    /**
     * The size of the field for entering data
     */
     ...
     */
    public static final int YEARS_BETWEEN_DECADES = 10;
    /**
     * The relative value to indicate the size of the year label on the grid compared to the margin size
     */
    public static final int YEAR_MARGIN = 4;
